...
<div class="selection-wrapper">
  <div class="container">
    <div class="row">
      <div class="head-text">
        <h2><span class="green">Pro</span> fruit salad</h2>
      </div>
      <div class="selection-content">
        <div class="row">
          ...
          <hr />
          <span  class="total">Total</span> ₦<input value="12000" style="border:none; background-color:transparent" name="fname" type="text" class="savee" id="total"><br><br>
